            ...
            <div class="card-body">
                <div class="form-row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="number" min="0" step="1000" class="form-control" value="{{ old('price') }}" id="price" name="price">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="number" min="1" step="1" class="form-control" value="{{ old('length') }}" id="length" name="length">
                    </div>
                    <div class="form-group col-6">
                        <label for="icon">آیکون</label>
                        <select class="form-control select2 w-100" id="icon" name="icon">
                            <option value="free.png" {{ old('icon') == 'free.png' ? 'selected' : '' }}>آبی</option>
                            <option value="silver.png" {{ old('icon') == 'silver.png' ? 'selected' : '' }}>نقره ای</option>
                            <option value="bronze.png" {{ old('icon') == 'bronze.png' ? 'selected' : '' }}>برنزی</option>
                            <option value="gold.png" {{ old('icon') == 'gold.png' ? 'selected' : '' }}>طلایی</option>
                        </select>
                    </div>
                    <div class="form-group col-6">
                        <label for="fee">کمیسیون سایت (درصد)</label>
                        <input type="number" min="1" class="form-control" id="fee" required name="features[fee]" value="{{ old('features.fee') }}">
                    </div>
                    <div class="form-group col-6">
                        <label for="max">انجام پروژه همزمان (حداکثر)</label>
                        <input type="number" min="-1" class="form-control" id="max" required name="features[max]" value="{{ old('features.max') }}">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="number" min="-1" class="form-control" id="portfolio" required name="features[portfolio]" value="{{ old('features.portfolio') }}">
                        <span class="text-mute form-text text-secondary small">عدد -1 به معنای نامحدود میباشد !</span>
                    </div>
                    <div class="form-group col-6">
                        <label for="desc1">توضیح دلخواه شماره اول</label>
                        <input type="text" class="form-control" id="desc1" name="features[desc1]" value="{{ old('features.desc1') }}">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" id="desc2" name="features[desc2]" value="{{ old('features.desc2') }}">
                        <span class="text-mute form-text text-secondary small">این توضیحات به عنوان آیتم در صفحه پکیج ها نمایش داده میشود</span>
                    </div>
                    <div class="form-group col-6">
                        <label for="popular">پکیج محبوب شود ؟</label>
                        <div>
                            <input type="checkbox" name="popular" id="popular" {{ old('popular') ? 'checked' : '' }}>
                            <label for="popular">
                                محبوب
                            </label>
                        </div>
                    ...
                    <div class="form-group col-12">
                        ...
                        <input type="number" min="0" step="1" class="form-control" value="{{ old('min') }}" id="min" name="min">
