...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">راهنما جدید</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <select class="form-control select2 w-100" id="location" name="location">
                            <option value="intro" {{ old('location') == 'intro' ? 'selected' : '' }}>معرفی</option>
                            <option value="freelancer" {{ old('location') == 'freelancer' ? 'selected' : '' }}>مجری یا فریلنسر</option>
                            <option value="employer" {{ old('location') == 'employer' ? 'selected' : '' }}>خریدار یا کارفرما</option>
                            <option value="financial" {{ old('location') == 'financial' ? 'selected' : '' }}>امور مالی</option>
                            <option value="law" {{ old('location') == 'law' ? 'selected' : '' }}>مسائل حقوقی</option>
                            <option value="other" {{ old('location') == 'other' ? 'selected' : '' }}>سایر موارد</option>
                        </select>
                    </div>
                    <div class="form-group col-12">
                        <label for="content">توضیحات</label>
                        <textarea type="text" name="content" class="form-control editordata" id="content">{{ old('content') }}</textarea>
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
