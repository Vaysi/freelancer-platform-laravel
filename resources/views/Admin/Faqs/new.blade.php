...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">پرسش جدید</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <select class="form-control select2 w-100" id="location" name="location">
                            <option value="freelancer" {{ old('location') == 'freelancer' ? 'selected' : '' }}>پرسش های مجریان</option>
                            <option value="employer" {{ old('location') == 'employer' ? 'selected' : '' }}>پرسش های خریداران</option>
                            <option value="financial" {{ old('location') == 'financial' ? 'selected' : '' }}>موارد مالی</option>
                            <option value="other" {{ old('location') == 'other' ? 'selected' : '' }}>متفرقه</option>
                        </select>
                    </div>
