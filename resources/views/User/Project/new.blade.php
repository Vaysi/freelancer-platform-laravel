            ...
            <div class="col-12 mb-3" id="newProject">
                <div class="card custom">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('user.project.store') }}" method="post" class="corner" enctype="multipart/form-data">
                            @csrf
                            <div class="timeline pb-5">
                                <div class="form-group timeline-item">
                                    ...
                                    <select name="category_id" id="category" class="selectpicker mb-2 d-block w-auto" title="موضوع پروژه خود را انتخاب کنید">
                                        ...
                                        <option value="{{ $category->id }}" data-icon="w-20p text-center fa {{ $category->icon ? $category->icon : '' }}">{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    <div class="subCat">
                                        <select name="subcategory" id="subcategory" class="selectpicker mb-2 d-block w-auto " title="ابتدا موضوع و سپس زیر موضوع انتخاب کنید">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group timeline-item">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('title') }}" maxlength="150" placeholder="عنوان پروژه را وارد کنید" name="title" id="title">
                                </div>
                                <div class="form-group timeline-item">
                                ...
                                <div class="form-group timeline-item">
                                    ...
                                    <textarea class="form-control" placeholder="پروژه درخواستی خود را شرح دهید" name="content" id="content" rows="6">{{ old('content') }}</textarea>
                                ...
                                <div class="form-group timeline-item">
                                    ...
                                    <select name="min_guarantee" id="min_guarantee" class="selectpicker mb-2 d-block w-auto" title="حداقل ضمانت تخصص">
                                        <option value="0" {{ old('min_guarantee') == "0" ? 'selected' : '' }} label="الزامی نیست" class="text-success">الزامی نیست</option>
                                        <option value="5" {{ old('min_guarantee') == 5 ? 'selected' : '' }} label="5%">5% از کل مبلغ پروژه</option>
                                        <option value="10" {{ old('min_guarantee') == 10 ? 'selected' : '' }} label="10%">10% از کل مبلغ پروژه</option>
                                        <option value="15" {{ old('min_guarantee') == 15 ? 'selected' : '' }} label="15%">15% از کل مبلغ پروژه</option>
                                        <option value="20" {{ old('min_guarantee') == 20 ? 'selected' : '' }} label="20%">20% از کل مبلغ پروژه</option>
                                        <option value="25" {{ old('min_guarantee') == 25 ? 'selected' : '' }} label="25%">25% از کل مبلغ پروژه</option>
                                    </select>
                                </div>
                                <div class="alert alert-yellow rounded-corner-5">
                                    <div class="row row-eq-height">
                                ...
                                <div class="form-row row-eq-height">
                                    <div class="col-4 mb-2">
                                        <div class="card custom h-100">
                                            ...
                                            <div class="card-body text-center">
                                                <label class="my-2"><input type="checkbox" name="private" value="1" class="pOption toggle color-secondary has-animation is-large" /></label>
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="card custom h-100">
                                            ...
                                            <div class="card-body text-center">
                                                <label class="my-2"><input type="checkbox" name="hidden" value="1" class="pOption toggle color-primary has-animation is-large" /></label>
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="card custom h-100">
                                            ...
                                            <div class="card-body text-center">
                                                <label class="my-2"><input type="checkbox" name="special" value="1" class="pOption toggle color-warning has-animation is-large" /></label>
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="card custom h-100">
                                            ...
                                            <div class="card-body text-center">
                                                <label class="my-2"><input type="checkbox" name="urgent" value="1" class="pOption toggle color-danger has-animation is-large" /></label>
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="card custom h-100">
                                            ...
                                            <div class="card-body text-center">
                                                <label class="my-2"><input type="checkbox" name="hire" value="1" class="pOption toggle color-info has-animation is-large" /></label>
                                    ...
                                    <div class="col-4 mb-2">
                                        <div class="card custom h-100">
                                            ...
                                            <div class="card-body text-center">
                                                <label class="my-2"><input type="checkbox" name="sticky" value="1" class="pOption toggle color-primary has-animation is-large" /></label>
                                ...
                                <div class="form-group timeline-item pt-3">
                                    ...
                                    <button class="btn btn-info" type="submit"><i class="fa fa-check-square"></i> ارسال درخواست </button>
                                    <button type="submit" name="draft" class="btn btn-secondary"><i class="fa fa-file"></i> ذخیره در پیشنویس </button>
